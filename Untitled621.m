...
for idx = 1:length(p_selected)
    ...
    [~, iter_J_all(idx), err_J] = jacobi_method_p621(A, b, x0, p, tol_iter, max_iter);
    err_J_all{idx} = err_J;
    [~, iter_GS_all(idx), err_GS] = gauss_seidel_method_p621(A, b, x0, p, tol_iter, max_iter);
...
p_demo = 0.5;
[~, iter_J_demo, err_J_demo] = jacobi_method_p621(A, b, x0, p_demo, 1e-8, 200);
[~, iter_GS_demo, err_GS_demo] = gauss_seidel_method_p621(A, b, x0, p_demo, 1e-8, 200);
